...
const JeeExam = () => {
    return (
        <div className='container my-5'>
            <h2 className='text-center my-5'><FontAwesomeIcon className='mr-2' icon={faBookReader} />JEE Preparation</h2>
            <div className='row  d-flex justify-content-center align-items-center'>
                <div className='col-md-7 text-left mt-4'>
                    ...
                    <br/> <br/> <br/>
                    <button className='btn btn-primary py-2 px-5 rounded ml-5'>Prepare for JEE now</button>
                </div>
